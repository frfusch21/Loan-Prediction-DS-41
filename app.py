...
def run_ml_app():
    ...
    property_area = st.selectbox('Proprty Area', ('Semiurban', 'Urban', 'Rural'))
...
def predict(gender, married, dependent, education, self_employed, applicant_income, coApplicant_income
    ...
    prediction = Logistic_Regression_model.predict([gen,mar,dep,edu,sem,applicant_income, cap, lam,
